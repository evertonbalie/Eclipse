		...
		statusCode: {
			406: function(xhr) {
				...
				$("#alert-areainteresse")
					...
					.text("Área de Interesse já existe no seu cadastro, por favor escolha outra!")
					.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
				window.setTimeout(function() {
					$(".alert")
						.fadeTo(1500, 0)
			...
			407: function(xhr) {
				...
				$("#alert-areainteresse")
					.addClass("alert alert-danger alert-dismissible")
					.text("Desculpe :( , somente três áreas podem ser cadastradas!")
					.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
				window.setTimeout(function() {
					$(".alert")
						.fadeTo(1500, 0)
	...
	$.ajax({
		...
		statusCode: {
			406: function (xhr) {
				console.log("> error: ", xhr.responseText);
				$(".close").trigger('click');
				alert("Esta experiencia já existe, por favor insira outra!!! ");
				$("#alert-experiencia")
					.addClass("alert alert-danger alert-dismissible")
			...
			407: function (xhr) {
				console.log("> error: ", xhr.responseText);
				$(".close").trigger('click');
				alert("Desculpe :(, somente três experiências podem ser cadastradas.");
				$("#alert-experiencia")
					.addClass("alert alert-danger alert-dismissible")
					.text("Desculpe :(, somente três experiências podem ser cadastradas.")
					.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
				window.setTimeout(function() {
					$(".alert")
						.fadeTo(1500, 0)
		...
		error: function(xhr) {
			...
			$("#alert-experiencia")
				.addClass("alert alert-danger alert-dismissible")
				.text("Algo aconteceu de errado, tente novamente.")
				.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
			window.setTimeout(function() {
				$(".alert")
					.fadeTo(1500, 0)
	...
	$.ajax({
		...
		statusCode: {
			406: function (xhr) {
				...
				$("#alert-curso")
					.addClass("alert alert-warning alert-dismissible")
					.text("Este curso já existe, por favor insira outro!!! ")
					.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
		...
		error: function(xhr) {
			...
			$("#alert-curso")
				.addClass("alert alert-danger")
				.text("Não foi possível salvar este curso.")
				.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
		},
	...
	$.ajax({
		...
		statusCode: {
			406: function (xhr0) {
				...
				$("#alert-formacao")
					.addClass("alert alert-warning alert-dismissible")
					.text("Esta escolaridade já existe, por favor insira outra!!! ")
					.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
		...
		error: function(xhr) {
			...
			$("#alert-formacao")
				.addClass("alert alert-danger alert-dismissible")
				.text("Algo deu errado!!!, não foi possível salvar esta formação.")
				.append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>");
		},
